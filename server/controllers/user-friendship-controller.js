...
class UserFriendshipController {
   ...
   async unsubscribe(req, res, next) {
      try {
         const subscriberId = req.params.subscriberId;
         const id = req.params.id;
         const action = await userFriendshipService.unsubscribe(
            id,
            subscriberId,
         );
         res.json(action);
   ...
   async acceptFriend(req, res, next) {
      try {
         ...
         const action = await userFriendshipService.acceptFriend(
            id,
            subscriberId,
         );
         res.json(action);
   ...
   async rejectFriend(req, res, next) {
      try {
         const id = req.params.id;
         const subscriberId = req.params.subscriberId;
         const action = await userFriendshipService.rejectFriend(
            id,
            subscriberId,
         );
         res.json(action);
   ...
   async deleteFriend(req, res, next) {
      try {
         const id = req.params.id;
         const subscriberId = req.params.subscriberId;
         const action = await userFriendshipService.deleteFriend(
            id,
            subscriberId,
         );
         res.json(action);
