...
import { firstMessageSentences } from "../../utils/firstMessageSentences";
...
const MessagesList = ({
   ...
   React.useEffect(() => {
      setRandomSentence(
         Math.floor(Math.random() * firstMessageSentences.length),
      );
   ...
   return (
      <div
         ref={ref}
         className={
            isScrolling ? st.messages__scroll : st.messages__scroll_invis
         }
      >
